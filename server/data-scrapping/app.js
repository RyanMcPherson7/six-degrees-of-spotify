const {
  populateArtistIdSet,
  populateConnections,
} = require('./src/populate-connections')

// TODO: import this list from another file maybe inside of config
const seedingArtistList = [
  {
    artistContentString:
      'Justin Bieber|1uNFoZAHBGtllmzznpCI3s|https://i.scdn.co/image/ab6761610000e5eb8ae7f2aaa9817a704a87ea36',
...
// TODO: create a config file that contains these variables and import them
// TODO: maybe have data contained in the `/server/` level since the server needs it
// const ARTIST_SET_ID_FILE = './data/artist-set-id-55.txt'
const artistIdSetFile = './data/set-test.txt'
// const connectionsFile = './data/connections-55.txt'
const connectionsFile = './data/con-test.txt'

// FIXME: this function needs to be blocking, meaning the rest of the code needs to wait for it
// currently, we're returning the set while we're reading data from it (bc we're using the async read file)
// so I'm pretty sure this does not work as intended
const artistIdSet = populateArtistIdSet(artistIdSetFile)
