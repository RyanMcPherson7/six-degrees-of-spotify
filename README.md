...
3. Upon request, the server will generate an unweighted, bidirectional [graph](https://en.wikipedia.org/wiki/Graph_(abstract_data_type)) with 19,215 vertices (artists) and 205,907 edges (connections) from a [`flat-file`](/server/data/connections-50.txt)
